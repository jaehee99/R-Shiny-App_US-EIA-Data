...
Shows all of the scatterplots between variables in one glance, also this is not interactive plot, but will provide overall relationships between the variables. 
