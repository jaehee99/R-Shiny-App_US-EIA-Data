...
Business analysts, economists, policymakers, or general public who may want to analyze the usage of different sources of energy as well as the price by different states. 
...
* `ggplot2` - ggplot2 helps to create graphics
* `ggthemes` - ggthemes provides extra themes such as theme_bw()
* `ggcorrplot` - ggcorrplot is a graphical display of a correlation matrix using ggplot2
* `GGally`- GGally is an extension to ggplot2 and it includes pairwise plot matrix
...
* `ggplot2` - In order to run the app the use of version >= 3.0.0 is required.  
* `ggthemes` - In order to run the app the use of version >= .  
* `ggcorrplot` - In order to run the app the use of version >= 0.1.3 is suggested.  
* `GGally` - In order to run the app the use of version >= . 
