...
## Data Source 
The data was gathered from the eia API https://www.eia.gov/opendata/ . In order to access the data, we used the eia package. The data that is used in the app consists of yearly and monthly and daily...
...
The univariate tab allows the user to see the distribution for each of the variables. This allows the user to see how different energy sources or energy prices are demanded in each state. Also, this tab allows the user to choose between a frequency polygon, a histogram and a density plot so the user may visualize the variables as prefered.

The bivariate tab allows the user to
...
https://www.degruyter.com/document/doi/10.2202/1935-1690.1607/html
